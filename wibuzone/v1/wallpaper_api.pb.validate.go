...
// Validate checks the field values on GetRandomWallpaperRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetRandomWallpaperRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetRandomWallpaperRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetRandomWallpaperRequestMultiError, or nil if none found.
func (m *GetRandomWallpaperRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *GetRandomWallpaperRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	// no validation rules for LikedByProfileId

	if len(errors) > 0 {
		return GetRandomWallpaperRequestMultiError(errors)
	}

	return nil
}

// GetRandomWallpaperRequestMultiError is an error wrapping multiple validation
// errors returned by GetRandomWallpaperRequest.ValidateAll() if the
// designated constraints aren't met.
type GetRandomWallpaperRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetRandomWallpaperRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetRandomWallpaperRequestMultiError) AllErrors() []error { return m }

// GetRandomWallpaperRequestValidationError is the validation error returned by
// GetRandomWallpaperRequest.Validate if the designated constraints aren't met.
type GetRandomWallpaperRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetRandomWallpaperRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetRandomWallpaperRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetRandomWallpaperRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetRandomWallpaperRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetRandomWallpaperRequestValidationError) ErrorName() string {
	return "GetRandomWallpaperRequestValidationError"
}

// Error satisfies the builtin error interface
func (e GetRandomWallpaperRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetRandomWallpaperRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetRandomWallpaperRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetRandomWallpaperRequestValidationError{}

// Validate checks the field values on GetRandomWallpaperResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetRandomWallpaperResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetRandomWallpaperResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetRandomWallpaperResponseMultiError, or nil if none found.
func (m *GetRandomWallpaperResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *GetRandomWallpaperResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, GetRandomWallpaperResponseValidationError{
					field:  "Wallpaper",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return GetRandomWallpaperResponseValidationError{
				field:  "Wallpaper",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return GetRandomWallpaperResponseMultiError(errors)
	}

	return nil
}

// GetRandomWallpaperResponseMultiError is an error wrapping multiple
// validation errors returned by GetRandomWallpaperResponse.ValidateAll() if
// the designated constraints aren't met.
type GetRandomWallpaperResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetRandomWallpaperResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetRandomWallpaperResponseMultiError) AllErrors() []error { return m }

// GetRandomWallpaperResponseValidationError is the validation error returned
// by GetRandomWallpaperResponse.Validate if the designated constraints aren't met.
type GetRandomWallpaperResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetRandomWallpaperResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetRandomWallpaperResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetRandomWallpaperResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetRandomWallpaperResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetRandomWallpaperResponseValidationError) ErrorName() string {
	return "GetRandomWallpaperResponseValidationError"
}

// Error satisfies the builtin error interface
func (e GetRandomWallpaperResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetRandomWallpaperResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetRandomWallpaperResponseValidationError{}
