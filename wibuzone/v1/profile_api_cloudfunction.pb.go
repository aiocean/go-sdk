...
type GetProfileStatsHandlerFunc = func(context.Context, *GetProfileStatsRequest) (*GetProfileStatsResponse, error)

func GetProfileStatsHandler(w http.ResponseWriter, r *http.Request, do GetProfileStatsHandlerFunc) {
	if err := cfutil.ApplyCors(w, r); err != nil {
		cfutil.WriteError(w, r, http.StatusInternalServerError, err)
		return
	}
	...
	var request GetProfileStatsRequest
	if err := cfutil.ReadRequest(r, &request); err != nil {
		cfutil.WriteError(w, r, http.StatusBadRequest, err)
		return
	}
