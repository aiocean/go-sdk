...
type GetRandomWallpaperHandlerFunc = func(context.Context, *GetRandomWallpaperRequest) (*GetRandomWallpaperResponse, error)

func GetRandomWallpaperHandler(w http.ResponseWriter, r *http.Request, do GetRandomWallpaperHandlerFunc) {
	if err := cfutil.ApplyCors(w, r); err != nil {
		cfutil.WriteError(w, r, http.StatusInternalServerError, err)
		return
	}
	...
	var request GetRandomWallpaperRequest
	if err := cfutil.ReadRequest(r, &request); err != nil {
		cfutil.WriteError(w, r, http.StatusBadRequest, err)
		return
	}
